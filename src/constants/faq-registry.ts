  ...
  SCREENVEIL: [
    {
      ...
      answer: "Yes, it acts as a screen dimmer, but the maximum battery savings are achieved on AMOLED/OLED displays where pixels physically turn off."
    },
    {
      question: "How is this different from YouTube Premium?",
      answer: "ScreenVeil is a universal hardware-level utility. It works across all apps (Netflix, Prime, etc.) and provides a 'pocket mode' that prevents accidental touches while the video continues."
    },
    {
      question: "What is ScreenVeil?",
      answer: "ScreenVeil is a free Android utility with 10,000+ downloads and a 4.4-star rating. It provides a black overlay for AMOLED/OLED displays, saving 60%+ battery life while listening to videos."
    }
  ],
  FOMOGEN: [
    {
  ...
  MINDFUL_GUARD: [
    {
      ...
      answer: "Mindful Guard is a privacy-focused Android productivity guardian that helps users reclaim 2.4 hours of focus daily. It features a zero-telemetry, offline architecture and system-level blocking."
    },
    {
      question: "Does MindfulGuard work on Xiaomi/Samsung/MIUI devices?",
      answer: 'Yes. MindfulGuard is engineered with "Battery Optimization Exemption" protocols specifically to prevent aggressive Android skins like MIUI from killing the background process.'
    },
    {
      question: "Is MindfulGuard safe for privacy?",
      answer: "Yes. MindfulGuard operates on a zero-telemetry architecture. It does not require internet access to function, ensuring your data never leaves your device."
    },
    {
      question: "How does Strict Mode work?",
      answer: "Strict Mode locks your chosen settings for a set duration. It prevents you from uninstalling the app or changing the schedule until the timer expires."
    }
  ],
  DIGITAL_WELLNESS: [
    {
