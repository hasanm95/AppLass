...
faqs:
  ...
  - question: "Quelle est la différence entre une limite de temps et un blocage programmé ?"
    answer: "Une limite de temps dit 'tu peux utiliser cette application 30 minutes par jour.' Un blocage programmé dit 'cette application ne s'ouvre pas entre 9h et 17h.' Les limites de temps nécessitent de la volonté — vous choisissez toujours si vous appuyez sur 'ignorer.' Le blocage programmé supprime complètement le choix pendant la fenêtre définie, ce qui explique pourquoi il fonctionne là où les limites de temps échouent."
  - question: "Le blocage de l'application bloque-t-il aussi ses notifications ?"
    answer: "Oui — et c'est l'un des avantages les plus sous-estimés. Quand Mindful Guard bloque une application, ses notifications sont également supprimées. Plus de pings Instagram, plus d'alertes Twitter, plus de sons TikTok qui vous rappellent à l'ordre. La boucle de distraction est brisée à la source, pas seulement au niveau de l'icône."
  - question: "Puis-je définir des horaires différents pour les jours de semaine et le week-end ?"
    answer: "Oui. Mindful Guard vous permet de choisir les jours d'activation de chaque programme, donc vos week-ends restent totalement libres pendant que votre fenêtre de travail du lundi au vendredi est protégée. Vous pouvez aussi créer plusieurs programmes — un blocage strict le matin avant 8h et un blocage plus léger l'après-midi de 13h à 15h, par exemple."
  - question: "Et si j'ai besoin d'accéder à une application bloquée pour le travail ?"
    answer: "Mindful Guard propose un Mode Standard et un Mode Strict. Le Mode Standard permet une courte fenêtre de dérogation si vous avez vraiment besoin d'accès — utile si votre travail exige de consulter LinkedIn ou Twitter occasionnellement. Le Mode Strict n'a aucune dérogation. Commencez par le Mode Standard et passez au Mode Strict si vous abusez des dérogations."
  - question: "Mindful Guard est-il sûr ? Collecte-t-il mes données ?"
    answer: "Mindful Guard utilise une architecture zéro tracking, entièrement sur l'appareil. Il ne nécessite que la permission d'Accès à l'utilisation pour surveiller quelle application est au premier plan — aucune donnée de localisation, aucun contact, aucun identifiant personnel. Vos habitudes d'utilisation ne quittent jamais votre téléphone."
---
...
![Comparaison côte à côte de l'écran de limite de temps souple de Bien-être numérique Android avec un bouton ignorer versus l'écran de blocage strict de Mindful Guard sans dérogation](../../../assets/blogs/digital-wellbeing-vs-mindful-guard-block-screen-android.png)
...
![Téléphone Android affichant l'écran de blocage de Mindful Guard lors d'une tentative d'ouverture d'Instagram pendant les heures de travail, indiquant "Bloqué jusqu'à 17:00 — Restez concentré"](../../../assets/blogs/mindful-guard-instagram-block-screen-work-hours-android.png)
...
![Infographie en deux colonnes montrant quelles applications Android bloquer pendant les heures de travail avec Mindful Guard à gauche, et quelles applications de productivité laisser débloquées à droite](../../../assets/blogs/android-apps-block-vs-unblock-work-hours-mindful-guard.png)
