    ...
    <div className="space-y-12">
      <header>
        ...
        <p className="mt-6 max-w-2xl text-xl leading-relaxed font-medium text-slate-500">
          The core of the cognitive firewall. Enforce zero-bypass focus sessions
      ...
      <div className="rounded-[2.5rem] border border-red-50 bg-red-50/10 p-12">
        <p className="mb-4 font-black tracking-widest text-red-600 uppercase">
          Warning
        </p>
        <h3 className="mb-4 text-2xl font-black text-slate-900">
          No Recovery Possible
        </h3>
        <p className="max-w-lg text-lg leading-relaxed font-medium text-slate-500">
          Strict Mode is designed to be permanent for the duration you set.
          There is no &quot;Emergency Unlock&quot; by design. Use with
          intention.
        </p>
      </div>
    </div>
