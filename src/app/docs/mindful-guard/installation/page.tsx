...
export default function MindfulGuardInstallationPage() {
  return (
    <div className="space-y-12">
      <header>
        ...
        <p className="mt-6 max-w-2xl text-xl font-medium leading-relaxed text-slate-500">
          Step-by-step instructions for deploying the cognitive firewall to 
          your Android device.
        </p>
      </header>
      ...
      <div className="rounded-[2.5rem] border border-slate-100 bg-[#FAFBFD] p-12">
        <h3 className="mb-4 text-2xl font-black text-slate-900">Ready to block?</h3>
