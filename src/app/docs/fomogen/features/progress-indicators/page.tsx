      ...
      <div className="space-y-24">
          ...
          <div className="rounded-[2.5rem] border border-slate-100 bg-[#FAFBFD] p-10 lg:p-14">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/10 lg:p-10">
              ...
              <p className="mt-6 text-center text-lg font-black text-slate-900">
                Add $15.00 more for <span className="text-blue-600">FREE SHIPPING!</span> 🚚
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="rounded-[2.5rem] bg-slate-900 p-12 text-white">
          ...
          <p className="text-xl font-medium leading-relaxed opacity-80">
            This module is a <strong>visual communication layer</strong>. You must
            independently configure your Free Shipping rates or Discount logic in
            the Shopify Admin panel to ensure financial reconciliation at
            checkout.
          </p>
        </div>
      </div>
