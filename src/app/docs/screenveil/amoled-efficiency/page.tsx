  ...
  return (
    <div className="space-y-12">
      ...
      <section className="space-y-8">
        <h2 className="text-2xl font-black text-slate-900">Power Draw Analysis</h2>
        <p className="text-lg font-medium text-slate-500">
          On OLED and AMOLED displays, each pixel is its own light source. By 
          displaying &quot;True Black,&quot; ScreenVeil instructs pixels to 
          turn completely off.
        </p>
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-3xl border border-slate-100 p-8">
            <h4 className="font-black text-slate-900 mb-4 uppercase tracking-widest text-xs">AMOLED Logic</h4>
          ...
          <div className="rounded-3xl border border-slate-100 p-8">
            <h4 className="font-black text-slate-400 mb-4 uppercase tracking-widest text-xs">LCD Logic</h4>
            <p className="text-sm font-medium text-slate-500">
...
function StatCard({ title, value, description, icon }: { title: string; value: string; description: string; icon: React.ReactNode }) {
  return (
    <div className="rounded-[2.5rem] border border-slate-100 bg-white p-10 shadow-sm transition-all hover:shadow-xl">
      ...
      <h3 className="mb-4 text-xs font-black uppercase tracking-widest text-blue-600">
        {title}
      </h3>
