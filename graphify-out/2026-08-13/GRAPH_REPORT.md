# Graph Report - AppLass  (2026-08-12)

## Corpus Check
- 467 files · ~1,774,240 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4397 nodes · 4929 edges · 334 communities (318 shown, 16 thin omitted)
...
Cohesion: 0.43
Nodes (6): COUNTRY_TO_LOCALE, Env, fetch(), getCookie(), hasLocalePrefix(), LOCALES
...
Cohesion: 0.14
Nodes (14): 10. Animation Decision Checklist, 1. Duration Principles, 7. Hover Effects Principles, 9. Performance Principles, Animation Guidelines Reference, Anti-Patterns, Choosing Duration, Duration Ranges by Purpose (+6 more)

### Community 14 - "Mobile Color System Reference"
Cohesion: 0.11
Nodes (18): 1. Mobile Color Fundamentals, 3. Dark Mode Design, 4. Outdoor Visibility, 8. Color Anti-Patterns, 9. Color System Checklist, ❌ AI Color Mistakes, Before Choosing Colors, Before Release (+10 more)
...
Cohesion: 0.29
Nodes (6): Conclusion: Reclaim Your 3 Hours, Enter Mindful Guard: Engineering Intentional Friction, The Path to Digital Wellness, The Three Pillars of the Mindful Guard Logic:, The "Willpower Gap" in Productivity, Why Accessibility Matters for Focus
...
Cohesion: 0.29
Nodes (6): Conclusion : Récupérez vos 3 Heures, Le Chemin vers le Bien-être Numérique, Le "Fossé de la Volonté" dans la Productivité, Les Trois Piliers de la Logique Mindful Guard :, Mindful Guard : Ingénierie de la Friction Intentionnelle, Pourquoi l'Accessibilité est Essentielle pour la Concentration
...
Cohesion: 0.25
Nodes (7): Comment fonctionnent réellement les limites quotidiennes et par session, Comparatif rapide, L'essentiel, Les trois façons de bloquer la vidéo courte sur Android, Pas à pas : configurer Reel Guard en moins de deux minutes, Plateforme par plateforme, Pourquoi bloquer les Reels et les Shorts est plus difficile que bloquer une application
...
Cohesion: 0.29
Nodes (6): Calcul :, Conclusion, Exemple :, Gamifier l'Expérience Client, La Logique Mathématique : Trouver Votre Nombre Optimal, Maîtriser Vos Marges

### Community 195 - "Why Architecture Is the Deciding Factor"
Cohesion: 0.29
Nodes (6): L'Impact sur la Batterie, La Matrice Logique, Le Piège de la « Volonté », Le Problème de la Confidentialité, Ma Recommandation Finale, Pourquoi l'Architecture est le Facteur Décisif
...
Cohesion: 0.25
Nodes (7): Fazit, Schritt für Schritt: YouTube Shorts in unter zwei Minuten blockieren, Shorts gegenüber dem Rest von YouTube, Tageslimit oder Sitzungslimit, Warum „blockier einfach YouTube“ ein schlechter Rat ist, Warum das Ausblenden der Shorts-Leiste nicht genügt, Was wirklich funktioniert: Blockieren auf Feed-Ebene
...
Cohesion: 0.25
Nodes (7): Bottom line, Daily limit vs. per-session limit, Shorts vs. the rest of YouTube, Step by step: block YouTube Shorts in under two minutes, What actually works: feed-level blocking, Why "just block YouTube" is bad advice, Why the Shorts shelf toggle isn't enough
...
### Community 273 - "extract-translations.ts"
Cohesion: 0.40
Nodes (3): Candidate, extracted, files
...
Cohesion: 0.22
Nodes (8): Einen Warenkorb-Timer in Shopify einrichten, Fazit, Reserviert Shopify den Bestand beim Hinzufügen zum Warenkorb?, Vier Regeln für einen ehrlichen Timer, Warenkorb-Timer im Vergleich, Was leistet ein Warenkorb-Timer dann tatsächlich?, Wenn Sie eine echte Reservierung brauchen: Entwurfsaufträge, Wie lange sollte ein Shopify Warenkorb-Timer laufen?
...
Cohesion: 0.22
Nodes (8): Bottom line, Cart timer vs the alternatives, Does adding an item to a Shopify cart reserve inventory?, Four rules for a timer that stays honest, How long should a Shopify cart reservation timer be?, Setting up a cart timer on Shopify, So what does a cart reservation timer actually do?, When you need a real reservation: draft orders

### Community 302 - "7. Accessibility Guidelines"
Cohesion: 0.25
Nodes (7): Ce qui fonctionne vraiment : le blocage au niveau du fil, L'essentiel, Les Shorts face au reste de YouTube, Limite quotidienne ou limite par session, Pas à pas : bloquer les Shorts YouTube en moins de deux minutes, Pourquoi « bloquez simplement YouTube » est un mauvais conseil, Pourquoi masquer l'étagère Shorts ne suffit pas
...
Cohesion: 0.29
Nodes (6): Fazit, Ganze App sperren oder nur Reels, Reels-Limit gegenüber den Alternativen, Schritt für Schritt: Instagram Reels in unter zwei Minuten blockieren, Tageslimit oder Sitzungslimit für Reels, Warum es keinen echten Aus-Schalter für Reels gibt

### Community 309 - "7. Animation Principles"
Cohesion: 0.29
Nodes (6): Bottom line, Daily limit vs. per-session limit for Reels, Reels-only limit vs. the alternatives, Step by step: block Instagram Reels in under two minutes, Whole-app block vs. Reels-only block, Why there's no real "off" switch for Reels
...
Cohesion: 0.50
Nodes (4): 2. OLED Considerations, Battery Savings with OLED, How OLED Differs, True Black vs Near Black
...
## Knowledge Gaps
- **2872 isolated node(s):** `Colors`, `Colors`, `$schema`, `style`, `rsc` (+2867 more)
...
- **Why does `Decision Trees & Context Templates` connect `Decision Trees & Context Templates` to `3. Dark Mode Design`, `9. Color System Checklist`, `8. Hierarchy Principles`, `8. Portfolio Guidelines {#portfolio}`, `4. Animation Performance (Both Platforms)`, `1. Color Theory Fundamentals`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Animation Guidelines Reference` connect `Animation Guidelines Reference` to `4. 3D CSS Transforms`, `1. Framework Selection`, `2. State Management Selection`, `7. Project Type Templates`, `4. Outdoor Visibility`, `8. Hierarchy Principles`, `8. Security for Mobile`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
